...
def f(theta1, theta2,omega1_i,omega2_i):
    f_funcion=(-3*math.sin(theta1)-math.sin(theta1-theta2)-2*math.sin(theta1-theta2)*(omega2_i**2+(omega1_i**2)*math.cos(theta1-theta2)))/(3-math.cos(2*theta1-2*theta2))
    return f_funcion
